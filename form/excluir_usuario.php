		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<center><h2><font face="Trebuchet MS, Arial, Helvetica, sans-serif" >EXCLUIR USUARIO</font></h2>
				...
				<div class="modal-body" align="center">
					<div class="form-group" background-color="white">
						...
						<table  class="table-striped table-list list" >
							<form class="form-horizontal" name="form1" method="POST" action="../grava_bd/excluir_grava_usuario.php"/>
