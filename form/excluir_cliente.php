		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<center><h2><font face="Trebuchet MS, Arial, Helvetica, sans-serif" >EXCLUIR CLIENTE</font></h2>
						<strong>Opa!!!! Se excluir não será possivel voltar..</strong>
					</div>

				<div class="modal-body" align="center">
					<div class="form-group" background-color="white">
						
						<table  class="table-striped table-list list" width="700">
							<form class="form-horizontal" name="form1" method="POST" action="../grava_bd/excluir_grava_cliente.php">
